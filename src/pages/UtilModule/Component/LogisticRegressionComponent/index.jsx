...
import { LogisticRegression } from "../../Module/LogisticRegression";
...
const LogisticRegressionComponent = () => {
    ...
    const computeResult = (value, type) => {
        ...
        classifier.fit(param1, param2);

        const yPredicted = classifier.predict(param3);
        console.log(yPredicted);
        setResultValue(yPredicted);
    }
